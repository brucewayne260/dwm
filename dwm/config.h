...
static const char *colors[][3]      = {
	...
	[SchemeTagsSel]  = { "#4c566a", col_gray1,  col_gray2  }, // Tagbar left selected {text,background,not used but cannot be empty}
	[SchemeTagsNorm]  = { "#4c566a", col_gray1,  col_gray2  }, // Tagbar left unselected {text,background,not used but cannot be empty}
	[SchemeInfoSel]  = { col_gray3, col_gray1,  col_gray2  }, // infobar middle  selected {text,background,not used but cannot be empty}
